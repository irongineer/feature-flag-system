...
class FeatureFlagEvaluator {
    ...
    constructor(optionsOrConfig = {}) {
        ...
        (0, environment_1.debugLog)(this.environment, 'FeatureFlagEvaluator initialized', { environment: this.environment });
    ...
    async isEnabled(contextOrTenantId, flagKey) {
        ...
        try {
            ...
            if (tenantOverride !== undefined) {
                ...
                (0, environment_1.debugLog)(environment, `Tenant override found for flag: ${normalizedFlagKey}`, { value: tenantOverride });
            ...
            (0, environment_1.debugLog)(environment, `Default value used for flag: ${normalizedFlagKey}`, { value: defaultValue });
            return defaultValue;
        }
        catch (error) {
            const errorInfo = {
    ...
    async checkKillSwitch(flagKey) {
        try {
            ...
            this.errorHandler('Kill-switch check failed:', error);
            return false;
        }
    }
