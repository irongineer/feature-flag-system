 ...
 * 環境変数でオーバーライド
 */
function applyEnvironmentOverrides(config: ApiEnvironmentConfig, env: ApiEnvironment): ApiEnvironmentConfig {
 ...
 */
export function getClientConfig(environment?: ApiEnvironment): Pick<ApiEnvironmentConfig, 'name' | 'api'> {
